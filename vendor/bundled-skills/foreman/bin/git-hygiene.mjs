...
//   source tree or <path> — a containment guard (assertContainment) hard-refuses
 ...
 * Foreman source, or a repo nested INSIDE the Foreman source. Neither <path> nor
 * <path> is a repo today, so this never fires in practice — it is a hard
