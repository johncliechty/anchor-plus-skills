# W11 delta-coverage stub gate — the general-lane session TRANSCRIPT
# persistence surface, re-named in THIS wave's delta.
#
# AUTH-ON: not-a-surface
#
# Same standing situation as the W8/W9/W10 stub gates: the LIVE Anchor
# service keeps appending to its Doctor session's persisted transcript
...
# journals 0070/0082). This wave's gate re-asserts the shape contract.
import sys
...
def test_w11_delta_names_the_transcript_surface():
